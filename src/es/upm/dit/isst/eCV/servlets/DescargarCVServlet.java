...
public class DescargarCVServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String investigadorId = (String)req.getSession().getAttribute("investigadorId").toString();
		
		Integer investigadorInt =  Integer.parseInt(investigadorId);
		Investigador investigador = InvestigadorDAOImplementation.getInstance().read(investigadorInt);
		...
		if(!situacion.isEmpty()) {
			...
			//table.addHeaderCell("Modalidad contrato");
			...
			for(SituacionProfesional i  : situacion){
				...
				//table.addCell(i.getModalidadContrato());
